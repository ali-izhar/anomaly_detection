...
def create_dataset(config_path: str = "configs/dataset_config.yaml",
                  graph_config_path: str = "configs/graph_config.yaml") -> Dict:
    ...
    if config.save_format == "h5":
        ...
        for graph_type in dataset.keys():
            ...
            save_func(
                ...
                adjacency=adjacency,
                features=features,
                change_points=np.array(dataset[graph_type]["change_points"], dtype=object),
