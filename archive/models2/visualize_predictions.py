...
from synthetic_data.create_graph_sequences import (
    GraphType,
    GraphConfig,
...
def prepare_model_input(
    graphs: List[nx.Graph], config: Dict, device: torch.device
    ...
    return {"adj_matrices": adj_matrices.to(device), "features": features.to(device)}
